    ...
    <div class='col-lg-10'>
        <div class='input-group mb-2'>
            <div class='input-group-text '>
                <input class="form-check-input" type="radio" name="real-imag-radio" value='real-imag' id="real-imag-radio" v-model='output_mode'>
            </div>
            <input type='text' class="form-control" placeholder="Real/Imag" disabled>
        
            <div class="input-group-text">
                <input class="form-check-input" type="radio" name="dBRadio" value='dB-phase' id="dBRadio" v-model='output_mode'>
            </div>
        ...
        <div class='input-group mb-2'>
            <div class='input-group-text'>
                <input class="form-check-input" type="radio" name="csvRadio" value='csv' id="csvRadio" v-model='output_type'>
            </div>
            <input type='text' class="form-control" placeholder=".csv" disabled>
        
            <div class="input-group-text">
                <input class="form-check-input" type="radio" name="s2pRadio" value='s2p' id="s2pRadio" v-model='output_type' >
            </div>
            <input type='text' class="form-control" :placeholder="sparams.length == 1 ? 's1p':'s2p'" disabled>
        </div>
    </div>

    <div class='d-flex col-lg-2'>
    <button type='button' class="btn btn-success btn-lg" id="outputButton" @click="download" :disabled='getResultDB.length == 0'>Download</button>
    </div>
